...
namespace FitnessSiteMVC.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Entries_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LowerDescription = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodItems_Entries_EntryId",
                        column: x => x.EntryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NutrientName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodNutrients_FoodItems_FoodItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entries_ProfileId",
                table: "Entries",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodItems_EntryId",
                table: "FoodItems",
                column: "EntryId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodNutrients_FoodItemId",
                table: "FoodNutrients",
                column: "FoodItemId");
        }
